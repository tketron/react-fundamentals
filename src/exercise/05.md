...
Components can be styled using inline styles with the `style` prop. Components
can also be given CSS classes using the `className` prop.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=tketron%40gmail.com).
