...
JSX is syntactic sugar over the React `createElement` API. Interpolation in JSX
uses `{}`. Spread operator is useful for adding multiple props to elements.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=tketron%40gmail.com).
