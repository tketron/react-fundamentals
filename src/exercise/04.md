...
React components use uppercase naming. Functions can be used to create reusable
components by returning JSX. React fragments using either `React.Fragment` or
`<>` can render two children as siblings without a single parent container.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=tketron%40gmail.com).
